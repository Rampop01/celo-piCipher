    ...
    <div data-tracking="track-8785ef" className="min-h-screen bg-transparent text-neutral-50 font-sans selection:bg-[#35D07F] selection:text-black">
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-black/80 backdrop-blur-xl border-b border-white/10 py-4' : 'bg-transparent py-6'}`}>
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <Link href="/" className="flex items-center gap-3 select-none hover:opacity-80 transition-opacity">
            ...
            <div data-testid="text-0fd74a" className="w-full max-w-6xl animate-in fade-in slide-in-from-bottom-8 duration-700">
              <div className="text-center mb-16">
                ...
                <p data-testid="container-e8dfc6" className="text-base md:text-xl text-neutral-400 max-w-2xl mx-auto font-mono">
                  &gt; Look at the 4 pictures and guess the hidden word. Speak your answer out loud to pass! Beat all 50 levels to earn real rewards and exclusive NFT Badges.
                </p>
              </div>
          ...
          <>
            ...
            <section className="pt-32 pb-16 md:pt-52 md:pb-32 px-4 md:px-6 flex flex-col items-center justify-center text-center">
              ...
              <p data-component-id="3b297e53" className="text-neutral-400 text-base md:text-xl tracking-widest uppercase max-w-2xl leading-relaxed mb-8 md:mb-12">
                Decrypt the visuals. <br/> Speak the hidden word. <br/> Claim the bounty.
              </p>
              ...
              <div data-testid="text-ae180f" className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-8 md:gap-16">
                <div data-theme-role="primary-surface" className="flex-1 space-y-6 md:space-y-8">
                  ...
                  <p data-component-id="28893f60" className="text-sm md:text-lg text-neutral-400 leading-relaxed font-mono">
                    &gt; You are presented with 4 seemingly random images. They all share one conceptual link. Can you find it?
                    The catch: revealing fewer images rewards you with a significantly higher multiplier on your Celo bounty.
                  </p>
                  <ul className="space-y-4 font-mono">
                    {[
                      "Dynamic generation means no two puzzles are alike.",
            ...
            <section id="how-it-works" className="py-20 md:py-32 px-4 md:px-6 max-w-7xl mx-auto border-b border-[#35D07F]/20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                  { icon: BrainCircuit, title: "CRYPTIC VISUALS", desc: "Every puzzle consists of 4 highly abstract images designed to test your deduction skills." },
            ...
            <footer className="border-t border-[#35D07F]/20 py-8 px-6 bg-black">
              <div data-theme-role="primary-surface" className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
                <Link href="/" className="text-2xl font-black tracking-tighter flex items-center hover:opacity-80 transition-opacity">
                  <span aria-label="Interactive element 45c2" className="text-white drop-shadow-[0_0_5px_rgba(255,255,255,0.8)]">Pi</span>
                  <span data-tracking="track-5a9684" className="text-[#35D07F] text-3xl drop-shadow-[0_0_12px_#35D07F] -ml-0.5 -mr-0.5">C</span>
                  <span data-tracking="track-bb8981" className="text-white drop-shadow-[0_0_5px_rgba(255,255,255,0.8)]">ipher</span>
                </Link>
