...
export default function TutorialPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-mono p-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(rgba(18,16,16,0)_50%,rgba(0,0,0,0.25)_50%),linear-gradient(90deg,rgba(53,208,127,0.06),rgba(0,0,0,0.02))] bg-[length:100%_4px,4px_100%] opacity-30 pointer-events-none"></div>
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <h1 className="text-4xl md:text-6xl font-black text-[#35D07F] tracking-tighter mb-4">
          OPERATIVE MANUAL
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="border border-[#35D07F]/30 bg-black/50 p-6 shadow-[0_0_15px_rgba(53,208,127,0.1)] hover:border-[#35D07F] transition-colors">
            ...
            <h2 className="text-xl font-bold text-[#35D07F] mb-2">1. THE OBJECTIVE</h2>
          ...
          <div className="border border-[#35D07F]/30 bg-black/50 p-6 shadow-[0_0_15px_rgba(53,208,127,0.1)] hover:border-[#35D07F] transition-colors">
            ...
            <h2 className="text-xl font-bold text-[#35D07F] mb-2">3. VOICE OVERRIDE</h2>
            <p className="text-neutral-300 text-sm leading-relaxed">
          ...
          <div className="border border-[#35D07F]/30 bg-black/50 p-6 shadow-[0_0_15px_rgba(53,208,127,0.1)] hover:border-[#35D07F] transition-colors">
            ...
            <h2 className="text-xl font-bold text-[#35D07F] mb-2">4. STRATEGIC TOOLS</h2>
            <p className="text-neutral-300 text-sm leading-relaxed">
