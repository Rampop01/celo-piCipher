                 ...
                 <div 
                    ...
                    {revealedImages[index] ? (
                      ...
                      <div className="flex flex-col items-center justify-center text-[#35D07F]/40 group-hover:text-[#35D07F] transition-colors">
                        ...
                        <span aria-label="Interactive element 2766" className="font-mono text-xs tracking-widest text-center transition-transform group-hover:animate-glitch-skew">DATA<br/>ENCRYPTED</span>
                      </div>
                    )}
                    {/* Scanline Overlay */}
        ...
        <div className="w-full p-6 border border-[#35D07F]/40 backdrop-blur-lg bg-black/60 relative shadow-[0_0_30px_rgba(53,208,127,0.1)]">
          ...
          <div aria-label="Interactive element 5a79" className="flex flex-col items-center mt-4">
            ...
            <div data-cy="cy-6f7368" className="w-full flex justify-center mb-6">
                 <div aria-label="Interactive element e8a5" className="flex items-center text-[#35D07F] font-mono text-2xl w-full max-w-sm border-b border-[#35D07F]/50 focus-within:border-[#35D07F] focus-within:shadow-[0_4px_15px_-3px_rgba(53,208,127,0.3)] pb-2 transition-all">
                   <input 
                      type="text" 
                      value={transcript}
                      onChange={(e) => {
